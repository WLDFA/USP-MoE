...
class StgnnSet(nn.Module): 
    ...
    def task4eval(self, param, node_index, init_index, test_dataloader, logger, test_meanstd, basemodel):
        ...
        if basemodel == 'v_STGCN5':
            ...
            indexstart = [0, 32, 64, 96, 128, 160, 192, 224, 256, 288, 320, 352, 384, 416, 448, 480]
            shapes = [(32, 1, 1, 4), (32, 1, 1, 4), (32, 1, 1, 4), (32, 8, 1, 4),
        ...
        with torch.no_grad():
            ...
            #pdb.set_trace()
            index = 0
            #print(self.model.state_dict()['filter_convs.0.weight'].shape)
